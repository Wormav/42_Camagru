<?php
/**
 * Post forgot-password confirmation page (GET /reset/sent).
 *
...
<section class="max-w-xl mx-auto px-4 sm:px-6 py-16 sm:py-24 text-center">
	...
	<span class="brutal-tag bg-cyan mx-auto">★ Check your inbox</span>

	<h1 class="font-display font-black text-display-lg mt-5 leading-[0.95]">
		Link <span class="highlight highlight--cyan">on its way</span>
	</h1>

	<p class="mt-6 text-base font-medium max-w-md mx-auto leading-relaxed">
		If the email you entered matches a verified account, we just sent a
	...
	<div class="mt-10 brutal-card bg-paper text-left max-w-md mx-auto">
		...
		<ol class="space-y-2 text-sm font-medium list-decimal pl-5">
			...
			<li>Click the reset link within one hour.</li>
			<li>Pick a new password and sign in.</li>
		</ol>
	</div>
	...
	<a href="/login" class="btn-brutal btn-brutal--white mt-8 inline-flex">
		← Back to sign in
	</a>
</section>
